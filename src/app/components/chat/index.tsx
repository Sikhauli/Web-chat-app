...
import Users from "../usersTable/index"
...
type UserSignInDetails = {
  ...
  type User = {
    username: string;
    userId: string;
    signInDetails: UserSignInDetails;
  };
  ...
  const iconItems = [
    {
      ...
      component: <Messages />,
      additionalClasses: 'flex flex-col items-center justify-center text-blue-600',
    ...
    },
    {
      id: 4,
      svg: (
        <svg fill="currentColor" viewBox="0 -64 640 640" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
...
const Chat = ({ signOut, user }: ChatProps) => {

    const [selectedIconId, setSelectedIconId] = useState<number | null>(null);
    const [currentComponent, setCurrentComponent] = useState<JSX.Element | null>(null);

    const handleComponentSelection = (id: number, component: JSX.Element | null) => {
    ...
    return (
        <div className="">
            <div className="flex bg-white dark:bg-gray-900 w-screen">
                ...
                <div className="w-80 h-screen dark:bg-gray-800 bg-gray-100 p-2 hidden md:block">
                    <div className="h-full overflow-y-auto">
                        <div className="text-xl font-extrabold text-gray-600 dark:text-gray-200 p-3">{user.signInDetails.loginId}</div>
